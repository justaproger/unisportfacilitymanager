...
const BookingDetail = () => {
  ...
  }, [id, isAuthenticated, navigate, bookingDataFromLocation, token]);
  ...
  const getQRCodeData = () => {
    ...
    const data = {
      ...
      facilityId: booking.facilityId || booking.facility,
      universityId: booking.universityId || booking.university,
    ...
    return (
      <div className="max-w-4xl mx-auto px-4 py-8">
        <div className="bg-white rounded-lg shadow-md p-6 text-center">
          ...
          <h1 className="text-2xl font-bold mt-4 mb-2">Error Loading Booking</h1>
  ...
  // Handle different property names that might come from API vs location state
  const facilityId = booking.facilityId || booking.facility;
  const universityId = booking.universityId || booking.university;
  const facilityName = booking.facilityName || booking.facility?.name || '';
  const universityName = booking.universityName || booking.university?.name || '';
            ...
            <div>
              ...
              <div className="flex items-start mb-6">
                ...
                <div>
                  ...
                  <Link to={`/universities/${universityId}`} className="text-primary hover:text-primary-dark">
                    {universityName}
                  </Link>
                </div>
              </div>
