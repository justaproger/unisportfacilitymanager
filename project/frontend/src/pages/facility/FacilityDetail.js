      ...
      try {
        ...
        setTimeout(() => {
          ...
          const mockFacility = {
            ...
            type: "swimming_pool",
            description: "Indoor 50-meter pool with 8 lanes, suitable for competitions and training. The facility includes spectator seating, electronic timing systems, and meets international swimming standards. Professional lifeguards are always on duty.",
          ...
          fetchAvailability(mockFacility._id, availabilityDate);
        }, 1000);
      } catch (error) {
