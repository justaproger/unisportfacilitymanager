...
const QRScanner = () => {
  ...
  const verifyBooking = async (data = null) => {
    ...
    try {
      ...
      // For demo purposes, we'll simulate with static data and delays
      ...
      setTimeout(() => {
        // Mock booking data
        if (bookingCode === 'XYZ123AB' || bookingCode === 'ABC123XY') {
          const mockBooking = {
            _id: '1',
            facilityId: '1',
          ...
          setVerificationStatus('invalid');
          setErrorMsg('Invalid booking code. No booking found with this code.');
        }
      ...
      setVerificationStatus('invalid');
      setErrorMsg('Error verifying booking. Please try again.');
      setLoading(false);
    }
  };
  ...
  const handleCheckIn = async () => {
    ...
    try {
      // In a real app, this would be an API call to check in the booking
      ...
      setErrorMsg('Error checking in booking. Please try again.');
      setLoading(false);
    }
  };
